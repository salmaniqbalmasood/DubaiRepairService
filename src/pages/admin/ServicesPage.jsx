...
const ServicesPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Washing Machine, Refrigerator & Appliance Repair in Dubai</title>
        <meta name="description" content="Professional appliance repair services in Dubai. We fix washing machines, refrigerators, ovens, ACs, and water heaters. View our services and pricing." />
      </Helmet>
      ...
      <div className="min-h-screen flex flex-col bg-background text-foreground">
        ...
        <main className="flex-1">
          {/* Hero Section - Using Gradient for visibility */}
            ...
            <div className="container mx-auto px-4 text-center">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-3xl mx-auto">
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Comprehensive appliance repair solutions across Dubai. Fast, reliable, and backed by our quality guarantee.
                </p>
              </motion.div>
            </div>
          </section>
                      ...
                      <div className="w-full md:w-1/2 space-y-6">
                        ...
                        <div className="pt-4">
                          <Button asChild size="lg" className="bg-primary text-white hover:bg-primary/90 font-semibold px-8 shadow-lg shadow-primary/20">
                            <Link to="/contact">Book {service.name}</Link>
                          </Button>
                        </div>
                      </div>
                    </div>
          ...
          {/* FAQ Section - Using 'bg-card' for better separation */}
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
              ...
              <Accordion type="single" collapsible className="w-full bg-card rounded-2xl border border-white/5 p-2 shadow-xl">
                <AccordionItem value="item-1" className="border-white/5 px-4">
                  ...
                  <AccordionContent className="text-muted-foreground">Yes, we offer same-day service for most appliance repairs across all areas of Dubai, subject to technician availability.</AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-2" className="border-white/5 px-4">
                  ...
                  <AccordionContent className="text-muted-foreground">Absolutely. We only use genuine OEM parts to ensure the longevity and safety of your appliances.</AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-3" className="border-none px-4">
                  ...
                  <AccordionContent className="text-muted-foreground">Yes, all our repairs come with a standard warranty on both parts and labor.</AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
          </section>
